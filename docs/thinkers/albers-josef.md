...
- "Color deceives continually" — the relativity of perceived color to context
- Teaching by experience, not by rule
- The *Vorkurs* as life-long practice, not first-year exercise
- Geometric abstraction as a genuine instrument of perception

## Key works

- *Homage to the Square* series (1950–76)
- *Interaction of Color* (1963; commemorative edition 2013)
- *Despite Straight Lines* (1961, with François Bucher)
- *Formulation: Articulation* (1972, screenprint portfolio)
- Bauhaus glass assemblages (1921–33)

## Secondary sources

- Frederick A. Horowitz and Brenda Danilowitz, *Josef Albers: To Open Eyes — The Bauhaus, Black Mountain College, and Yale* (2006) — the major study of the teaching across the three schools; the standard reference.
- Nicholas Fox Weber, *The Bauhaus Group: Six Masters of Modernism* (2009) — has the best biographical portrait of Albers; Weber directs the Josef and Anni Albers Foundation.
- Martin Duberman, *Black Mountain: An Exploration in Community* (1972) — the classic institutional history; central chapters on Albers.
- Heinz Liesbrock, ed., *Josef Albers: Interaction* (2018) — the major recent survey with new scholarship on the color work.
