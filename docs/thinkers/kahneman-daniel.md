...
tags: [psychology, economics, cognitive-science, behavioral-economics]
related: [simon-herbert, thaler-richard, tversky-amos]
influenced_by: [simon-herbert]
influenced: [thaler-richard]
---
...
- System 1 / System 2 — two modes of cognition
- The "experiencing self" vs. the "remembering self" — and the implications for well-being measurement
- *Noise* — unwanted variability in judgment as a distinct and large source of error

## Key works

- "Judgment under Uncertainty: Heuristics and Biases" (with Tversky, *Science*, 1974)
- "Prospect Theory: An Analysis of Decision under Risk" (with Tversky, *Econometrica*, 1979)
- *Judgment under Uncertainty* (ed. with Tversky and Slovic, 1982)
- *Choices, Values, and Frames* (ed. with Tversky, 2000)
- *Thinking, Fast and Slow* (2011)
- *Noise: A Flaw in Human Judgment* (with Sibony and Sunstein, 2021)

## Secondary sources

- Michael Lewis, *The Undoing Project: A Friendship That Changed Our Minds* (2016) — on the Kahneman-Tversky collaboration
