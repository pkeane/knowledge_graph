...
Her central constructive project is the *capabilities approach*, developed in collaboration with [[sen-amartya|Amartya Sen]] and given its fullest theoretical articulation in her own work — *Women and Human Development* (2000), *Frontiers of Justice* (2006), *Creating Capabilities* (2011). Where Sen kept the list of capabilities open and context-dependent, Nussbaum proposed a specific list of ten central capabilities (life; bodily health; bodily integrity; senses, imagination, and thought; emotions; practical reason; affiliation; other species; play; control over one's environment) that any decent society must secure for all its members above a threshold. The approach is explicitly indebted to Aristotle on human flourishing, to [[mill-js|Mill's]] *On Liberty* and *The Subjection of Women* on the conditions of free human development, and to a Kantian insistence on the inviolable dignity of each person.
...
- The capabilities approach (Nussbaum's version)
- Aristotelian human flourishing in a liberal frame
- Emotions as cognitive evaluations
- Universalism about women's capabilities
- Disgust and shame as politically corrosive emotions
