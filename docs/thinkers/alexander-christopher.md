...
- A "pattern language" — shared, scale-crossing solutions to dwelling problems
- The "quality without a name" — the criterion of good building
- Design by non-professionals, guided by patterns
- The fifteen structural properties of living order
- Against modernist architecture and the professional's monopoly on design
...
- *A Pattern Language* (1977, with Ishikawa and Silverstein)
- *The Timeless Way of Building* (1979)
- *The Production of Houses* (1985)
- *A New Theory of Urban Design* (1987)
- *The Nature of Order*, 4 vols. (2002–04)
- *The Battle for the Life and Beauty of the Earth* (2012)

## Secondary sources

- Stephen Grabow, *Christopher Alexander: The Search for a New Paradigm in Architecture* (1983) — the major critical-biographical study; based on extended interviews.
- Michael Mehaffy and Nikos A. Salingaros, *Design for a Living Planet* (2015) — the best short introduction by Alexander's closest contemporary collaborators.
- Howard Davis, *The Culture of Building* (1999) — places Alexander within the broader vernacular tradition.
- Richard P. Gabriel, *Patterns of Software* (1996) — the indispensable short book on how Alexander was read by the software world.
